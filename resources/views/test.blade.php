...
<div class="container" id="test">
  ...
  <!--
  <div class="row sticky-bottom navbar-expand-xl bg-secondary">
      <div class="row text-info">
          <div class="col-1">
          <span class="footer-hd-font">start</span>
          </div>
          <div class="col-1">
          <span class="footer-hd-font">BIB</span>
          </div>
          <div class="col-4">
          <span class="footer-hd-font">Name</span>
          </div>
          <div class="col-2">
          <span class="footer-hd-font">Pref</span>
          </div>
          <div class="col-4">
          <span class="footer-hd-font">Team</span>
          </div>
      </div>
  </div>
  -->
